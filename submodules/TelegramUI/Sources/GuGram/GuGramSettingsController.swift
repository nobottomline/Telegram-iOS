...
private func guGramSettingsControllerEntries(presentationData: PresentationData, ghostMode: Bool, localPremium: Bool, hideStories: Bool, editedMessages: Bool, bypassCopyProtection: Bool) -> [GuGramSettingsEntry] {
    ...
    entries.append(.editedMessages(presentationData.theme, "Edit History", editedMessages))
...
public func guGramSettingsController(context: AccountContext) -> ViewController {
    ...
    |> map { presentationData, ghostMode, localPremium, hideStories, editedMessages, bypassCopyProtection -> (ItemListControllerState, (ItemListNodeState, Any)) in
        let entries = guGramSettingsControllerEntries(presentationData: presentationData, ghostMode: ghostMode, localPremium: localPremium, hideStories: hideStories, editedMessages: editedMessages, bypassCopyProtection: bypassCopyProtection)
